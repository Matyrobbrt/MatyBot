package io.github.matyrobbrt.matybot.util.tuples;
...
public class Tuple2<T1, T2> implements Iterable<Object>, Serializable {
	...
	/**
	 * Map the left-hand part (T1) of this {@link Tuple2} into a different value and
	 * type, keeping the right-hand part (T2).
	 *
	...
	/**
	 * Map the right-hand part (T2) of this {@link Tuple2} into a different value
	 * and type, keeping the left-hand part (T1).
	 *
	...
	/**
	 * Turn this {@code Tuple} into a {@link List List&lt;Object&gt;}. The list
	 * isn't tied to this Tuple but is a <strong>copy</strong> with limited
	 * mutability ({@code add} and {@code remove} are not supported, but {@code set}
	 * is).
	 *
	...
	/**
	 * Turn this {@code Tuple} into a plain {@code Object[]}. The array isn't tied
	 * to this Tuple but is a <strong>copy</strong>.
	 *
	...
	/**
	 * Return an <strong>immutable</strong> {@link Iterator Iterator&lt;Object&gt;}
	 * around the content of this {@code Tuple}.
	 *
	 * @implNote As an {@link Iterator} is always tied to its {@link Iterable}
	 *           source by definition, the iterator cannot be mutable without the
	 *           iterable also being mutable. Since {@link Tuples} are
	 *           <strong>immutable</strong>, so is the {@link Iterator} returned by
	 *           this method.
	 *
